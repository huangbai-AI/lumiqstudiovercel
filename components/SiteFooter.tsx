    ...
    <footer className="footer">
      <div className="container">
        <div className="foot-grid">
          <div>
            <div className="foot-logo">
              ...
              <span className="serif">Lumiq Studio</span>
            </div>
            <p className="foot-blurb">Taking imagination to new heights!</p>
          </div>
        ...
        <div className="foot-bottom">
          <div className="text-lg">© 2026 Lumiq Studios Inc. All rights reserved.</div>
          <div className="text-lg">Wonder Starts Here</div>
        </div>
      </div>
    </footer>
  );
